package hu.akusius.palenque.anigifmaker.util;
...
public class UIUtils {
  ...
  public static boolean setLookAndFeel() {
    if (setLF("Nimbus") != true) {
      String message = "Cannot initialize Look&Feel! Possible cause: outdated Java version.";
      String title = "Error";
      JOptionPane.showMessageDialog(null, message, title, JOptionPane.ERROR_MESSAGE);
      return false;
    }

    UIManager.getLookAndFeelDefaults().put("nimbusOrange", new ColorUIResource(50, 50, 210));
