...
public final class ChangeSupport {
  ...
  /**
   * Csak akkor jelez változást, ha tényleg változtak az értékek.
   * @param oldValue
   * @param newValue
   */
   ...
   * @param newValue
   */
  public void fireChange(int oldValue, int newValue) {
   ...
   * @param newValue
   */
  public void fireChange(boolean oldValue, boolean newValue) {
    if (oldValue == newValue) {
      return;
    }
    fireChange();
